        ...
        using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
        {
            ...
            if (user == null)
            {
                user = new User
                {
                    ...
                    FirstName = "John",
                    LastName = "Doe",
                    Bio = "Fullstack Developer | C# / .NET / Blazor",
                    AboutMe = "I am a passionate Fullstack Developer based in Gothenburg, with a strong focus on building secure, scalable, and user-friendly web applications using the .NET ecosystem. I enjoy solving complex problems and am always eager to learn new technologies.\n\nOutside of coding, I am an AI enthusiast and have a background in digital healthcare development. I believe in the power of clean code and meaningful user experiences.",
